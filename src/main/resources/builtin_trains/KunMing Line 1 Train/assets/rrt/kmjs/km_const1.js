...
//字体库
const SOURCE_HAN_SANS_CN_BOLD = Resources.readFont(Resources.id("rrt:kmjs/fonts/source-han-sans-cn/source-han-sans-cn-bold.otf"));//黑体粗
//const XIAWU = Resources.readFont(Resources.id("rrt:kmjs/fonts/xiawu/xiawu.ttf"));//无衬线黑体
const SANS_LAO = Resources.readFont(Resources.id("rrt:kmjs/fonts/sans_lao/sans_lao.ttf"));//英文
//const GUANGKEKAI = Resources.readFont(Resources.id("rrt:kmjs/fonts/guangkekai/guangkekai.ttf"));//楷体
const UNIFONT_16PX = Resources.readFont(Resources.id("rrt:kmjs/fonts/unifont/unifont_16px.ttf"));//点阵
