 ...
 * 只能右键打开GUI，不能放置
 */
public class TrackConstructionControlPanelItem extends Item {
    
    public TrackConstructionControlPanelItem(Settings settings) {
        super(settings);
    }
        ...
        try {
            ...
            NamedScreenHandlerFactory screenHandlerFactory = new NamedScreenHandlerFactory() {
                ...
                public ScreenHandler createMenu(int syncId, PlayerInventory inventory, PlayerEntity player) {
                    return new TrackConstructionControlPanelScreenHandler(syncId, inventory, pos);
                }
