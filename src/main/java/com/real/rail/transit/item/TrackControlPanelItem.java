 ...
 * 只能右键打开GUI，不能放置
 */
public class TrackControlPanelItem extends Item {
    
    public TrackControlPanelItem(Settings settings) {
        super(settings);
    }
        ...
        try {
            ...
            NamedScreenHandlerFactory screenHandlerFactory = new NamedScreenHandlerFactory() {
                ...
                public ScreenHandler createMenu(int syncId, PlayerInventory inventory, PlayerEntity player) {
                    return new TrackControlPanelScreenHandler(syncId, inventory, pos);
                }
